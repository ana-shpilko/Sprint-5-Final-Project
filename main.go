...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	var TrainingInfoMessage InfoMessage
	TrainingInfoMessage.TrainingType = t.TrainingType
	TrainingInfoMessage.Duration = t.Duration
	TrainingInfoMessage.Distance = t.distance()
	TrainingInfoMessage.Speed = t.meanSpeed()
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	if r.Duration > 0 {
		RunningSpeed := r.meanSpeed()
		return ((CaloriesMeanSpeedMultiplier*RunningSpeed + CaloriesMeanSpeedShift) * r.Weight / MInKm * r.Duration.Hours() * MinInHours)
	}
	return 0
}
...
func (r Running) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	var RunningInfoMessage InfoMessage
	RunningInfoMessage.TrainingType = r.TrainingType
	RunningInfoMessage.Duration = r.Duration
	RunningInfoMessage.Distance = r.distance()
	RunningInfoMessage.Speed = r.meanSpeed()
	return RunningInfoMessage
}
...
func (w Walking) Calories() float64 {
	...
	WalkingSpeed := w.meanSpeed()
	Base := WalkingSpeed * KmHInMsec
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(Base, 2)/HeightInM)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	var WalkingInfoMessage InfoMessage
	WalkingInfoMessage.TrainingType = w.TrainingType
	WalkingInfoMessage.Duration = w.Duration
	WalkingInfoMessage.Distance = w.distance()
	WalkingInfoMessage.Speed = w.meanSpeed()
	return WalkingInfoMessage
}
...
func (s Swimming) Calories() float64 {
	// вставьте ваш код ниже
	SwimmingSpeed := s.meanSpeed()
	return (SwimmingSpeed + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier * s.Weight * s.Duration.Hours()
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	var SwimmingInfoMessage InfoMessage
	SwimmingInfoMessage.TrainingType = s.TrainingType
	SwimmingInfoMessage.Duration = s.Duration
	SwimmingInfoMessage.Distance = s.distance()
	SwimmingInfoMessage.Speed = s.meanSpeed()
	return SwimmingInfoMessage
}
